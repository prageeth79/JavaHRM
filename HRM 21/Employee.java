...
public class Employee extends DB{
    ...
    public boolean save(){
        return save(code,fullName,nameWithInit,nic,dateOfBirth,gender,designation.code,department.code,owner);
    }

    public  boolean update(){
        return update(code,fullName,nameWithInit,nic,dateOfBirth,gender,designation.code,department.code,owner);
    }
    ...
    protected boolean save(String code, String fullName, String nameWithInit, String nic, String DofB,
                           String gender, String desig, String dept, String owner){
        String sql = "Insert into employee Values('" + code + "','" + fullName + "','" +
                nameWithInit + "','" + nic + "','" + DofB + "','" + gender + "','" + desig +"','" + dept + "','" + owner + "')";
    ...
    public String[][] employeeDetailsAll(String userName) {
        ...
        try{
            ResultSet rs= this.dbResult(con, "select count(*) from Employee where user = '" + userName + "'");
            rs.next();
            ...
            rs = this.dbResult(con, "select e.*,d.depName,de.desigName from Employee e,Department D, " +
                    ...
                    " and e.user = '" + userName + "' order by e.code");
            int i = 0;
            while(rs.next()) {
