...
public class Department extends DB{
    ...
    public boolean matchManager(String manager){
        return manager.matches("^[a-z .]*[A-Z]*$");
    }
    ...
    public boolean save(String code, String deptName, String telNo, String manager){
        String sql = "Insert into department Values('" + code + "','" + deptName + "','" + telNo + "','" + manager + "')";
        return super.save(sql);
    }
    public boolean update(String code, String deptName, String telNo, String manager){
