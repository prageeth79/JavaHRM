...
public class EmployeeSkill  extends DB{
    ...
    public EmployeeSkill load(int id){
        String sql = "SELECT * from employeeSkills WHERE id = " + id ;
        ...
        try {
            ...
            //System.out.println(this.proficiency);
    ...
    protected boolean save(int skillId, String employeeCode, String proficiency){
        String sql = "Insert into employeeSkills Values(null,'" + employeeCode + "'," + skillId + ",'" + proficiency + "')";
