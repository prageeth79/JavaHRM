...
--
-- Table structure for table `educationqulification`
--

CREATE TABLE `educationqulification` (
  `id` int(11) NOT NULL,
  `empCode` varchar(10) NOT NULL,
  `qulification` int(11) NOT NULL,
...
--
-- Indexes for table `educationqulification`
--
ALTER TABLE `educationqulification`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `educationqulification`
--
ALTER TABLE `educationqulification`
