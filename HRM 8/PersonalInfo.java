...
public class PersonalInfo extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == btnSave){
            ...
            if(db.save(txtEmployeeNo.getText(),txtEmployeeFullName.getText(),txtEmployeeNameWithInit.getText(),
        ...
        if(e.getSource() == btnUpdate){
            ...
            if(db.update(txtEmployeeNo.getText(),txtEmployeeFullName.getText(),txtEmployeeNameWithInit.getText(),
                    txtEmployeeNIC.getText(),txtEmployeeDOFB.getText(),cmbEmployeeGender.getSelectedItem().toString(),
                    sDesignationId,sDepartmentId)) {
