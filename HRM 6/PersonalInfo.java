...
public class PersonalInfo extends JFrame implements ActionListener {
    ...
    JButton btnNew, btnSave, btnUpdate, btnDelete, btnCancel,btnAddDesig, btnAddDepart;
    ...
    String[] employeeFieldNames = {"Code", "Full Name", "Name With Init","NIC","Date of Birth","Gender","Department","Designation"};
    ...
    private void gridSelection(){
        ...
        tblEmpMod.addListSelectionListener(new ListSelectionListener(){
            @Override
            public void valueChanged(ListSelectionEvent e) {
               String sEmpCode = tblEmployee.getValueAt(tblEmployee.getSelectedRow(), 0).toString();
               db.load(sEmpCode);
               loadTextbox();
    ...
    public void loadTextbox(){
        ...
        sDesignationId = db.designation;
        txtEmployeeDesignation.setText(db.designation);
        sDepartmentId = db.department;
        txtEmployeeDepartment.setText(db.department);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == btnSave){
            ...
            db.save(txtEmployeeNo.getText(),txtEmployeeFullName.getText(),txtEmployeeNameWithInit.getText(),
                    txtEmployeeNIC.getText(),txtEmployeeDOFB.getText(),cmbEmployeeGender.getSelectedItem().toString(),
                    sDesignationId, sDepartmentId);
            tblEmployee.setModel( new DefaultTableModel(db.employeeDetailsAll(),employeeFieldNames));
            clearFields();
        }
        if(e.getSource() == btnUpdate){

            db.update(txtEmployeeNo.getText(),txtEmployeeFullName.getText(),txtEmployeeNameWithInit.getText(),
                    txtEmployeeNIC.getText(),txtEmployeeDOFB.getText(),cmbEmployeeGender.getSelectedItem().toString(),
                    sDesignationId,sDepartmentId);
        ...
        if(e.getSource() == btnDelete){
            db.delete(txtEmployeeNo.getText());
            tblEmployee.clearSelection();
            tblEmployee.setModel( new DefaultTableModel(db.employeeDetailsAll(),employeeFieldNames));
            clearFields();
        }
