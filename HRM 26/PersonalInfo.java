...
public class PersonalInfo extends EmploymentInfo implements ActionListener, KeyListener {
    ...
    public PersonalInfo(){
        ...
        tblEmployeeDepartment.getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, 0), "Enter");
        ...
        tblEmployeeDesignation.getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, 0), "Enter");
    ...
    protected  void setComponents(Employee db){
        ...
        lblDateFormat.setBounds(370, 160, 150, 25);
    ...
    protected void addComponents(){
        ...
        panPersonalInfo.add(txtEmployeeNo);
        panPersonalInfo.add(lblEmployeeNo);

        panPersonalInfo.add(txtEmployeeFullName);
        panPersonalInfo.add(lblEmployeeFullName);
    ...
    public void keyPressed(KeyEvent e) {
        if(e.getKeyCode() == KeyEvent.VK_ENTER){
            ...
            if(e.getSource() == btnUpdate) update();
