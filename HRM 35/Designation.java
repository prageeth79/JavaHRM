...
public class Designation extends DB{
    ...
    public Designation load(String code){
    ...
    protected boolean save(String code, String designation){
        String sql = "Insert into designation Values('" + code + "','" + designation + "')";
        return super.save(sql);
    }
    protected boolean update(String code, String designation){
    ...
    private boolean validateDesigName(){
        return validator.matchCharacters(designation);
    }
