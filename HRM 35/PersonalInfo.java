...
public class PersonalInfo extends EmployeeSkillInfo implements ActionListener, KeyListener {
    ...
    public PersonalInfo(){
        //System.out.println(Integer.parseInt(Utility.getComboID("4 - text").trim()) + "|");
    ...
    protected void setMenu(){
        super.setMenu();
        mnuAddDepartment.addActionListener(this);
        mnuAddDesignation.addActionListener(this);
        mnuAddSkills.addActionListener(this);
        mnuAddQualifications.addActionListener(this);
    ...
    protected  void setComponents(Employee db){
        ...
        ImageIcon iImage = new ImageIcon("images/hrm24.png");
        this.setIconImage(iImage.getImage());
        ...
        btnEduQualiNew.addActionListener(this);
        btnEduQualiSave.addActionListener(this);
        btnEduQualiUpdate.addActionListener(this);
        btnEduQualiDelete.addActionListener(this);
    }
    ...
    private void addTextBoxForcus(){
        ...
        txtEmployeeFullName.addFocusListener(new FocusListener()
        {
            ...
            public void focusLost(FocusEvent e) {
                ...
                if(txtEmployeeFullName.getText().isEmpty())
                    txtEmployeeFullName.setBorder(BorderFactory.createLineBorder(Color.RED, 2));
                else if(!db.validator.matchCharacters(txtEmployeeFullName.getText()))
                    {
                        txtEmployeeFullName.setBorder(BorderFactory.createLineBorder(Color.RED, 2));
        ...
        txtEmployeeNameWithInit.addFocusListener(new FocusListener()
        {
            ...
            public void focusLost(FocusEvent e) {
                ...
                if(txtEmployeeNameWithInit.getText().isEmpty())
                    txtEmployeeNameWithInit.setBorder(BorderFactory.createLineBorder(Color.RED, 2));
                else if(!db.validator.matchCharactersAndDot(txtEmployeeNameWithInit.getText()))
                    {
                        txtEmployeeNameWithInit.setBorder(BorderFactory.createLineBorder(Color.RED, 2));
        ...
        txtEmployeeNIC.addFocusListener(new FocusListener()
        {
            ...
            public void focusLost(FocusEvent e) {
                ...
                if(txtEmployeeNIC.getText().isEmpty())
                    txtEmployeeNIC.setBorder(BorderFactory.createLineBorder(Color.RED, 2));
                else if(!db.validator.matchNic(txtEmployeeNIC.getText()))
                    {
                        txtEmployeeNIC.setBorder(BorderFactory.createLineBorder(Color.RED, 2));
        ...
        txtEmployeeDOFB.addFocusListener(new FocusListener()
        {
            ...
            public void focusLost(FocusEvent e) {
                ...
                if(txtEmployeeDOFB.getText().isEmpty())
                    txtEmployeeDOFB.setBorder(BorderFactory.createLineBorder(Color.RED, 2));
                else if(!db.validator.matchDate(txtEmployeeDOFB.getText()))
                {
                    txtEmployeeDOFB.setBorder(BorderFactory.createLineBorder(Color.RED, 2));
    ...
    private void loadTextbox(){
        ...
        loadSkillTable(db.code);
        loadEduQualiTable(db.code);
        enableSkillComponent(true);
        enableEduQualiComponent(true);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == btnSkillNew) {
            txtboxnew();
            enableSkillSaveButton();
        }
        if(e.getSource() == btnSkillSave) {
            skillAdd();
            if (skill.save()) {
                JOptionPane.showMessageDialog(this,
                        "Record Added Successfully.", "ADD RECORD", JOptionPane.INFORMATION_MESSAGE);
        ...
        if(e.getSource() == btnSkillUpdate) {
            skillAdd();
            //System.out.println("IN UPDATE SKILL");
            if (skill.update()) {
                JOptionPane.showMessageDialog(this,
                        "Record Updated Successfully.", "ADD RECORD", JOptionPane.INFORMATION_MESSAGE);
                try {
                ...
                JOptionPane.showMessageDialog(this,
                        "Error In Record Update, you may be adding a existing record!", "ADD RECORD", JOptionPane.ERROR_MESSAGE);
            }

        }
        if(e.getSource() == btnSkillDelete){
            int option = JOptionPane.showConfirmDialog(this,
                    "Are you sure that you want to Delete this record?","Delete",JOptionPane.YES_NO_OPTION);
            if(option == 0 && skill.delete(db.code)) {
                txtboxnew();
                enableSkillNewButton();
                loadSkillTable(db.code);
                JOptionPane.showMessageDialog(this,
        ...
        if(e.getSource() == btnEduQualiNew) {
            txtEduQualiboxnew();
            enableEduQualiSaveButton();
        }
        if(e.getSource() == btnEduQualiSave) {
            eduQualiAdd();
        ...
        if(e.getSource() == btnEduQualiUpdate) {
            eduQualiAdd();
            //System.out.println("IN UPDATE SKILL");
        ...
        if(e.getSource() == btnEduQualiDelete){
            int option = JOptionPane.showConfirmDialog(this,
                    "Are you sure that you want to Delete this record?","Delete",JOptionPane.YES_NO_OPTION);
            if(option == 0 && skill.delete(db.code)) {
                txtEduQualiboxnew();
        ...
        if(e.getSource() == mnuAddNewUser) new AddNewUser(this);
        if(e.getSource() == mnuChangePassword) new ChangePassword(this);
        if(e.getSource() == mnuAddDepartment) new DepartmentInfo(this);
        if(e.getSource() == mnuAddDesignation) new DesignationInfo(this);
        if(e.getSource() == mnuAddSkills) new SkillsInfo(this);
        if(e.getSource() == mnuAddQualifications) new QualificationInfo(this);
    }
    ...
    public void keyPressed(KeyEvent e) {
        if(e.getKeyCode() == KeyEvent.VK_ENTER){
            e.consume();
            if(e.getSource() == txtEmployeeNo) txtEmployeeFullName.requestFocusInWindow();
            if(e.getSource() == txtEmployeeFullName) txtEmployeeNameWithInit.requestFocusInWindow();
            if(e.getSource() == txtEmployeeNameWithInit) txtEmployeeNIC.requestFocusInWindow();
            if(e.getSource() == txtEmployeeNIC) cmbEmployeeGender.requestFocusInWindow();
            if(e.getSource() == cmbEmployeeGender) txtEmployeeDOFB.requestFocusInWindow();
            if(e.getSource() == txtEmployeeDOFB) tblEmployeeDesignation.requestFocusInWindow();
            if(e.getSource() == tblEmployeeDesignation) tblEmployeeDepartment.requestFocusInWindow();
            if(e.getSource() == tblEmployeeDepartment) {
                tabEmployee.setSelectedIndex(1);
                txtDateAppointment.requestFocusInWindow();
            }
            if(e.getSource() == txtDateAppointment) txtDateMadePermanent.requestFocusInWindow();
            if(e.getSource() == txtDateMadePermanent) txtPersonalFileNo.requestFocusInWindow();
            if(e.getSource() == txtPersonalFileNo) txtIncrimentDate.requestFocusInWindow();
            if(e.getSource() == txtIncrimentDate) cmbClass.requestFocusInWindow();
            if(e.getSource() == cmbClass) cmbGrade.requestFocusInWindow();
            if(e.getSource() == cmbGrade) chkEBI.requestFocusInWindow();
            if(e.getSource() == chkEBI) chkEBII.requestFocusInWindow();
            if(e.getSource() == chkEBII) cmbStatus.requestFocusInWindow();
