...
public class Skill extends DB{
    ...
    public ResultSet skillComboData(){
        try{
            String sql = "Select skillId, skillName from skills";
            return dbResult(con, sql);
        }catch (Exception ignored){}
        return null;
    }

    public String[] skillCombo(){
        try{
    ...
    protected boolean save(String skillName, String description){
        String sql = "Insert into skills(skillName,description) Values('" + skillName + "','" + description + "')";
