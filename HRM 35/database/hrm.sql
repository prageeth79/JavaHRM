...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 27, 2023 at 05:34 PM
...
--
-- Dumping data for table `educationqualification`
--

INSERT INTO `educationqualification` (`id`, `empCode`, `qualification`, `institution`, `result`) VALUES
(1, '0001', 1, 'University of Moratuwa', 'M.Sc.'),
(2, '0001', 1, 'University of Kelaniya', 'B.Sc.');
...
('0002', 'Waligamage Sanath Kumara', 'W.S. Kumara', '111111111V', '1989-11-04', 'male', '0002', '0003', '2019-01-01', '2019-01-01', 'C000/001/001', '2019-01-01', 'Class III', 'Grade III', 0, 0, 'Working', 'admin'),
...
INSERT INTO `employeeskills` (`id`, `employeeid`, `skillId`, `proficiency`) VALUES
(7, '0001', 2, 'Good');
...
INSERT INTO `qualification` (`id`, `qualification`, `type`) VALUES
...
ALTER TABLE `employeeskills`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `employeeid` (`employeeid`,`skillId`);
...
--
-- AUTO_INCREMENT for table `educationqualification`
--
ALTER TABLE `educationqualification`
